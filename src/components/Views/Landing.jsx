...
const Landing = () => {
  return (
    ...
    <div className="h-[900px] w-[85%] m-auto flex flex-col md:flex-row justify-between ">
        <div className="flex items-center justify-center sm:w-96 md:w-[500px] lg:w-[500px]">
            <img src={landingImage} alt="coding person" width='700px' />
        </div>
        <div className="mr-20 mt-60 ">
            <h1 className='md:text-3xl lg:text-6xl xl:text-7xl font-bold mb-5 text-center'> Unlock Your <span className="text-[#E5BE7F]">Full Potential</span></h1>
